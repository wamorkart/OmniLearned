#!/bin/bash
# Evaluate the distilled minimal-MLP top-tagging student on the test split.
...
#          --gpus-per-node 4 -A m3246 bash evaluate_top_distill_mlp.sh
...
OUTPUT_DIR=/pscratch/sd/t/twamorka/omnilearned/eval/top_distill_mlp/
SAVE_TAG=${SAVE_TAG:-distill_top_mlp_small_scratch_a05_T4}
