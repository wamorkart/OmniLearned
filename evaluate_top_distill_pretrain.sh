#!/bin/bash
# Evaluate fine_tune_top_distill_pretrain_s_a05_T4 on the top test split.
...
#          --gpus-per-node 4 -A m3246 bash evaluate_top_distill_pretrain.sh
...
OUTPUT_DIR=/pscratch/sd/t/twamorka/omnilearned/eval/top_distill_pretrain/
