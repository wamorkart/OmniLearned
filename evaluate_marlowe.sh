...
# ============================================================
SAVE_TAG=fine_tune_pretrain_l_qg_int_i300_e10   # distill_top_small_scratch_a05_T4 # checkpoint name, under $CHECKPOINT_DIR
QUANTIZATION=int8                           # "none", "int8", "int8dq", or "bf16" ("fp16"/"int4" temporarily disabled)
# ============================================================
...
CHECKPOINT_DIR=/projects/m000255/mbenyas/output/fine_tune_pretrain_l_qg/ # /projects/m000255/twamorka/checkpoints
...
BATCH_SIZE=128
USE_PID_FLAG=--use-pid # ""                              # set to "" or --use-pid
