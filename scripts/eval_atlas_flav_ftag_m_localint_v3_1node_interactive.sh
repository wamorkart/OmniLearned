...
#          --gpus-per-node 4 -A m3246 bash scripts/eval_atlas_flav_ftag_m_localint_v3_1node_interactive.sh
# or via the resubmit loop: scripts/eval_loop_atlas_flav_ftag_m_localint_v3_1node.sh
