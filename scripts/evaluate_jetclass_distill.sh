#!/bin/bash
# Evaluate the distilled JetClass student on the test split.
...
#          --gpus-per-node 4 -A m3246 bash evaluate_jetclass_distill.sh
...
OUTPUT_DIR=/pscratch/sd/t/twamorka/omnilearned/eval/jetclass_distill/
