...
# message-passing layer, from-scratch-large-teacher arm (counterpart of train
# config top_deepsets_distillnet_gnn_teacherscratch). The interaction flags must
# match training exactly so evaluate.py rebuilds the same architecture before
